...
\title{Industrial Applications of Counting and Colouring Things In}
...
\block{Research Goals}{
    ...
    Despite this, results can be favourable. Our approach uses parallelism to \textbf{introduce
    diversity} into a search process to offset the weakest choices made by heuristics, so our
    parallel workers are reducing our commitment to potentially costly early mistakes.
}
